...
/**
 * @brief Melfa Ethernet SDK namespace. Refer to Mitsubishi Electric Industrial Robot Ethernet Function Instruction
...
{
/**
 * @brief Real Time External Control Class Object. Refer to Mitsubishi Electric Industrial Robot Ethernet Function
 * Instruction Manual for detailed descriptions
 *
 */
class rtexc
{
...
public:
  ...
  FB_packet fb_pack;
  /**
   * @brief Construct a rtexc::rtexc object. Initialize class variabes. If _WIN32, initialize WSAStartup. If debug,
   * prints "Debug mode active."
   *
   */
  ...
  /**
   * @brief Initialize Real Time External Control function on robot controller. Uses NULL command so not robot will not
   * move.
